...
constexpr StatusBar::AreaData STYLESHEET_720_1280_DARK_STATUS_BAR_AREA_DATA(int w_percent, StatusBar::AreaAlign align)
{
    return {
...
constexpr StatusBar::Data STYLESHEET_720_1280_DARK_STATUS_BAR_DATA = {
    .main = {
        .size = gui::StyleSize::RECT_W_PERCENT(100, 60),
        .background_color = gui::StyleColor::COLOR(0x38393A),
        .text_font = gui::StyleFont::SIZE(28),
        .text_color = gui::StyleColor::COLOR(0xFFFFFF),
    },
    .area = {
        .num = StatusBar::AREA_NUM_MAX,
        .data = {
            STYLESHEET_720_1280_DARK_STATUS_BAR_AREA_DATA(33, StatusBar::AreaAlign::START),
            STYLESHEET_720_1280_DARK_STATUS_BAR_AREA_DATA(34, StatusBar::AreaAlign::CENTER),
            STYLESHEET_720_1280_DARK_STATUS_BAR_AREA_DATA(33, StatusBar::AreaAlign::END),
        },
    },
    .icon_common_size = gui::StyleSize::SQUARE(36),
    .battery = {
